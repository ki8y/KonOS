...
if ($date -match "06") {
    ...
    $fileName = "rainbow"
    Invoke-WebRequest `
        -Uri "https://github.com/ki8y/KonOS/blob/master/Components/Universal/Wallpapers/Pride/rainbow.png?raw=true" `
...
if ($secretWallpaper -eq 1) {
    ...
    $fileName = "funny"
    Invoke-WebRequest `
        -Uri "https://github.com/ki8y/KonOS/blob/master/Components/Universal/Wallpapers/Funny/funny.png?raw=true" `
...
elseif ($secretWallpaper) {}
    ...
    $fileName = $Colour
    Invoke-WebRequest `
        -Uri "https://github.com/ki8y/KonOS/blob/master/Components/Universal/Wallpapers/Main/$($Colour).png?raw=true" `
