param(
    [switch]$SkipTitleScreen
)

Import-Module "$env:systemDrive\KonOS\Setup\Data\Variables.psm1"

# Get colours
$col = Get-Content "$KonOS\KonOS\Setup\Data\Colours.json" -Raw | ConvertFrom-Json
Import-Module "$KonOS\Setup\Modules\Write-Box.psm1"

# Pull Kon OS version :P
$Commit = Invoke-RestMethod -Uri "https://api.github.com/repos/ki8y/KonOS/commits/KonOS-Rewrite"
$Ver = Invoke-RestMethod -Uri "https://github.com/ki8y/KonOS/raw/KonOS-Rewrite/version.json"
