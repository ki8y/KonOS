...
set "name=DDU.exe"
mkdir "C:\Kon OS\Display Drivers\DDU"
set "location=C:\Kon OS\Display Drivers\DDU"
curl -s -L "%file%" -o "%location%\%name%"
:: DDU (SETTINGS FOLDER)
mkdir "C:\Kon OS\Display Drivers\DDU\Settings\AMD"
echo Settings\AMD...
mkdir "C:\Kon OS\Display Drivers\DDU\Settings\INTEL"
echo Settings\INTEL...
mkdir "C:\Kon OS\Display Drivers\DDU\Settings\Languages"
echo Settings\Languages...
mkdir "C:\Kon OS\Display Drivers\DDU\Settings\NVIDIA"
echo Settings\NVIDIA...
mkdir "C:\Kon OS\Display Drivers\DDU\Settings\REALTEK"
...
set "location=C:\Kon OS\Display Drivers\DDU\Settings\AMD"
echo AMD\%name%...
curl -s -L "%file%" -o "%location%\%name%"
...
set "location=C:\Kon OS\Display Drivers\DDU\Settings\INTEL"
echo INTEL\%name%...
curl -s -L "%file%" -o "%location%\%name%"
...
set "name=Arabic.xml"
set "location=C:\Kon OS\Display Drivers\DDU\Settings\Languages"
echo Languages\%name%...
curl -s -L "%file%" -o "%location%\%name%"
...
set "name=servicesaudio.cfg"
set "location=C:\Kon OS\Display Drivers\DDU\Settings\NVIDIA"
echo NVIDIA\%name%...
curl -s -L "%file%" -o "%location%\%name%"
...
set "name=packages.cfg"
set "location=C:\Kon OS\Display Drivers\DDU\Settings\REALTEK"
echo REALTEK\%name%...
curl -s -L "%file%" -o "%location%\%name%"
